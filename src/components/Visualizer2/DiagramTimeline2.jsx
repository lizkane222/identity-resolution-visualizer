...
function generateComprehensiveAnalysis(processedEvents, simulation) {
  ...
  analysis.keyInsights = [
    { icon: "/assets/bar-graph_search.svg", label: "Total Events Processed", value: totalEvents },
    { icon: "/assets/User-plus.svg", label: "New Profiles Created", value: createActions },
    { icon: "/assets/User-Checkmark.svg", label: "Additional Actions", value: addActions },
    { icon: "/assets/Unified-profiles.svg", label: "Profile Merges", value: mergeActions },
    { icon: "/assets/User-Profile.svg", label: "Final Profile Count", value: totalProfiles }
  ];
